...
function make_site_theme_from_oldschool($theme_name, $template)
{
     ...
     */
    $files = array('/' => '/', 'wp-layout.css' => 'style.css', 'wp-comments.php' => 'comments.php', 'wp-comments-popup.php' => 'comments-popup.php');
    ...
    foreach ($files as $oldfile => $newfile) {
        ...
        if ($oldfile == '/') {
            ...
            if (strpos($index, 'WP_USE_THEMES') !== false) {
                if (!@copy(WP_CONTENT_DIR.'/themes/'.WP_DEFAULT_THEME.'//', "$site_dir/$newfile")) {
                    return false;
                }
...
function make_site_theme_from_default($theme_name, $template)
{
    ...
    //$files = array('/', 'comments.php', 'comments-popup.php', 'footer.php', 'header.php', 'sidebar.php', 'style.css');
