...
/**
 * Checks that current theme files '/' and 'style.css' exists.
 *
 ...
 *                     Args
 *
 *     @var string $preprocessed Pre-processed CSS, stored in `post_content_filtered`. Normally empty string. Optional.
 *     @var string $stylesheet   Stylesheet (child theme) to update. Optional, defaults to current theme/stylesheet.
 * }
 *
...
function wp_update_custom_css_post($css, $args = array())
{
     ...
     *                    Custom CSS data
     *
     *     @var string $css          CSS stored in `post_content`
     *     @var string $preprocessed Pre-processed CSS stored in `post_content_filtered`. Normally empty string.
     * }
     *
     * @param array $args {
     *                    The args passed into `wp_update_custom_css_post()` merged with defaults
     *
     *     @var string $css          the original CSS passed in to be updated
     *     @var string $preprocessed the original preprocessed CSS passed in to be updated
     *     @var string $stylesheet   The stylesheet (theme) being updated.
     * }
     */
 ...
 *
 * @see https://core.trac.wordpress.org/ticket/39752
 * @since 4.8.0
