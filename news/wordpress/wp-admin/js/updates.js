...
(function ($, wp, settings) {
  ...
  wp.updates.installPluginSuccess = function (response) {
    ...
    if (response.activateUrl) {
      setTimeout(function () {
        ...
        $message
          .removeClass(
            "install-now installed button-primary-disabled button-secondary-disabled button-disabled updated-message"
          )
  ...
  wp.updates.installImporterError = function (response) {
    ...
    $installLink
      ...
      .attr(
        "aria-label",
        wp.updates.l10n.installNowLabel.replace("%s", pluginName)
      );
    ...
    setTimeout(function () {
      if (response.activateUrl) {
        ...
        $message
          ...
          .attr(
            "aria-label",
            wp.updates.l10n.activateThemeLabel.replace("%s", response.themeName)
          )
  ...
  $(function () {
    ...
    $("#plugin_install_from_iframe").on("click", function (event) {
      ...
      if (
        false === $.support.postMessage ||
        null === target ||
        -1 !== window.parent.location.pathname.indexOf("/")
      ) {
        return;
      }
