 ...
 * @global array $menu
 */
$menu[2] = array(__('Dashboard'), 'read', '/', '', 'menu-top menu-top-first menu-icon-dashboard', 'menu-dashboard', 'dashicons-dashboard');

$submenu['/'][0] = array(__('Home'), 'read', '/');

if (is_multisite()) {
    $submenu['/'][5] = array(__('My Sites'), 'read', 'my-sites.php');
}
