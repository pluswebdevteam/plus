...
class Theme_Upgrader extends WP_Upgrader
{
     ...
     *
     *     @var bool $clear_update_cache Whether to clear the updates cache if successful.
     *                                    Default true.
     * }
     *
     ...
     * It will return an error if the theme doesn't have style.css or /
     * files.
     *
     * @since 3.3.0
     *
    ...
    public function check_package($source)
    {
        ...
        // If it's not a child theme, it must have at least an / to be legit.
        if (empty($info['Template']) && !file_exists($working_directory.'/')) {
