...
class WP_Rewrite
{
    ...
    /**
     * Rules that don't redirect to WordPress' /.
     *
     ...
     *
     * Means that permalink links are enabled and / is in the URL.
     *
     * @since 1.5.0
     *
     * @return bool whether permalink links are enabled and / is in the URL
     */
     ...
     *
     * Using permalinks and / is not in the URL.
     *
     * @since 1.5.0
     *
     * @return bool whether permalink links are enabled and / is NOT in the URL
     */
    ...
    public function mod_rewrite_rules()
    {
        ...
        // Add in the rules that don't redirect to WP's / (and thus shouldn't be handled by WP at all).
    ...
    public function add_rule($regex, $query, $after = 'bottom')
    {
        ...
        // "external" = it doesn't correspond to /.
        if ($external) {
    ...
    /**
     * Adds a rewrite rule that doesn't correspond to /.
     *
     * @since 2.1.0
     *
     * @param string $regex regular expression to match request against
     ...
     *                       Default empty array.
     *
     *     @var bool $with_front  Whether the structure should be prepended with `WP_Rewrite::$front`.
     *                             Default true.
     *     @var int  $ep_mask     The endpoint mask defining which endpoints are added to the structure.
     *                             Accepts `EP_NONE`, `EP_PERMALINK`, `EP_ATTACHMENT`, `EP_DATE`, `EP_YEAR`,
     *                             `EP_MONTH`, `EP_DAY`, `EP_ROOT`, `EP_COMMENTS`, `EP_SEARCH`, `EP_CATEGORIES`,
     *                             `EP_TAGS`, `EP_AUTHORS`, `EP_PAGES`, `EP_ALL_ARCHIVES`, and `EP_ALL`.
     *                             Default `EP_NONE`.
     *     @var bool $paged       Whether archive pagination rules should be added for the structure.
     *                             Default true.
     *     @var bool $feed        Whether feed rewrite rules should be added for the structure. Default true.
     *     @var bool $forcomments Whether the feed rules should be a query for a comments feed. Default false.
     *     @var bool $walk_dirs   Whether the 'directories' making up the structure should be walked over
     *                             and rewrite rules built for each in-turn. Default true.
     *     @var bool $endpoints   Whether endpoints should be applied to the generated rules. Default true.
     * }
     */
