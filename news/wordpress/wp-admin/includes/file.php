 ...
 *
 *     @var string $file       relative path to file
 *     @var string $plugin     plugin being edited
 *     @var string $theme      theme being edited
 *     @var string $newcontent new content for the file
 ...
 *
 * @return bool|null false on failure, true on success
 */
function WP_Filesystem($args = false, $context = false, $allow_relaxed_file_ownership = false)
{
    ...
    if (!defined('FS_CHMOD_FILE')) {
        define('FS_CHMOD_FILE', (fileperms(ABSPATH.'/') & 0777 | 0644));
    }
 ...
 *
 * @see https://codex.wordpress.org/Editing_wp-config.php#WordPress_Upgrade_Constants
 *
 ...
 *
 *     @var string $group_label  The user-facing heading for the group, e.g. 'Comments'.
 *     @var array  $items        {
 *         An array of group items
 *         @var array  $group_item_data  {
 *             An array of name-value pairs for the item
 *             @var string $name   The user-facing name of an item name-value pair, e.g. 'IP Address'.
 *             @var string $value  The user-facing value of an item data pair, e.g. '50.60.70.0'.
 *         }
 *     }
 * }
 *
