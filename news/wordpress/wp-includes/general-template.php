 ...
 *
 *     @var bool   $echo           Whether to display the login form or return the form HTML code.
 *                                  Default true (echo).
 *     @var string $redirect       URL to redirect to. Must be absolute, as in "https://example.com/mypage/".
 *                                  Default is to redirect back to the request URI.
 *     @var string $form_id        ID attribute value for the form. Default 'loginform'.
 *     @var string $label_username Label for the username or email address field. Default 'Username or Email Address'.
 *     @var string $label_password Label for the password field. Default 'Password'.
 *     @var string $label_remember Label for the remember field. Default 'Remember Me'.
 *     @var string $label_log_in   Label for the submit button. Default 'Log In'.
 *     @var string $id_username    ID attribute value for the username field. Default 'user_login'.
 *     @var string $id_password    ID attribute value for the password field. Default 'user_pass'.
 *     @var string $id_remember    ID attribute value for the remember field. Default 'rememberme'.
 *     @var string $id_submit      ID attribute value for the submit button. Default 'wp-submit'.
 *     @var bool   $remember       whether to display the "rememberme" checkbox in the form
 *     @var string $value_username Default value for the username field. Default empty.
 *     @var bool   $value_remember Whether the "Remember Me" checkbox should be checked by default.
 ...
 *
 * @since 1.5.0
 * @see https://core.trac.wordpress.org/ticket/1458 Explanation of 'wp_meta' action.
 */
function wp_meta()
{
    /*
...
function wp_get_document_title()
{
     ...
     *
     *     @var string $title   title of the viewed page
     *     @var string $page    Optional. Page number if paginated.
     *     @var string $tagline Optional. Site description when on home page.
     *     @var string $site    Optional. Site title when not on home page.
     * }
     */
 ...
 *
 *     @var string     $type            Type of archive to retrieve. Accepts 'daily', 'weekly', 'monthly',
 *                                       'yearly', 'postbypost', or 'alpha'. Both 'postbypost' and 'alpha'
 *                                       display the same archive link list as well as post titles instead
 *                                       of displaying dates. The difference between the two is that 'alpha'
 *                                       will order by post title and 'postbypost' will order by post date.
 *                                       Default 'monthly'.
 *     @var string|int $limit           Number of links to limit the query to. Default empty (no limit).
 *     @var string     $format          Format each link should take using the $before and $after args.
 *                                       Accepts 'link' (`<link>` tag), 'option' (`<option>` tag), 'html'
 *                                       (`<li>` tag), or a custom format, which generates a link anchor
 *                                       with $before preceding and $after succeeding. Default 'html'.
 *     @var string     $before          Markup to prepend to the beginning of each link. Default empty.
 *     @var string     $after           Markup to append to the end of each link. Default empty.
 *     @var bool       $show_post_count Whether to display the post count alongside the link. Default false.
 *     @var bool|int   $echo            Whether to echo or return the links list. Default 1|true to echo.
 *     @var string     $order           Whether to use ascending or descending order. Accepts 'ASC', or 'DESC'.
 *                                       Default 'DESC'.
 *     @var string     $post_type       Post type. Default 'post'.
 * }
 *
 * @return string|void string when retrieving
 */
 ...
 *
 * @see https://msdn.microsoft.com/en-us/library/bb463265.aspx
 * @since 2.3.1
 */
 ...
 *
 * @since 4.3.0
 * @see https://www.whatwg.org/specs/web-apps/current-work/multipage/links.html#rel-icon HTML5 specification link icon.
 */
 ...
 *                    Args
 *
 *     @var string   $type       the MIME type of the file to be edited
 *     @var string   $file       Filename to be edited. Extension is used to sniff the type. Can be supplied as alternative to `$type` param.
 *     @var WP_Theme $theme      theme being edited when on theme editor
 *     @var string   $plugin     plugin being edited when on plugin editor
 *     @var array    $codemirror additional CodeMirror setting overrides
 *     @var array    $csslint    CSSLint rule overrides
 *     @var array    $jshint     JSHint rule overrides
 *     @var array    $htmlhint   JSHint rule overrides.
 * }
 *
 ...
 *
 *     @var string $base               Base of the paginated url. Default empty.
 *     @var string $format             Format for the pagination structure. Default empty.
 *     @var int    $total              The total amount of pages. Default is the value WP_Query's
 *                                      `max_num_pages` or 1.
 *     @var int    $current            The current page number. Default is 'paged' query var or 1.
 *     @var string $aria_current       The value for the aria-current attribute. Possible values are 'page',
 *                                      'step', 'location', 'date', 'time', 'true', 'false'. Default is 'page'.
 *     @var bool   $show_all           Whether to show all pages. Default false.
 *     @var int    $end_size           How many numbers on either the start and the end list edges.
 *                                      Default 1.
 *     @var int    $mid_size           How many numbers to either side of the current pages. Default 2.
 *     @var bool   $prev_next          Whether to include the previous and next links in the list. Default true.
 *     @var bool   $prev_text          The previous page text. Default '&laquo; Previous'.
 *     @var bool   $next_text          The next page text. Default 'Next &raquo;'.
 *     @var string $type               Controls format of the returned value. Possible values are 'plain',
 *                                      'array' and 'list'. Default is 'plain'.
 *     @var array  $add_args           An array of query args to add. Default false.
 *     @var string $add_fragment       A string to append to each link. Default empty.
 *     @var string $before_page_number A string to appear before the page number. Default empty.
 *     @var string $after_page_number  A string to append after the page number. Default empty.
 * }
 *
 ...
 *
 *     @var string $base    SVG icon base color
 *     @var string $focus   SVG icon color on focus
 *     @var string $current SVG icon color of current admin menu link.
 * }
 */
